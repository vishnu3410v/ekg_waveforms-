...
# Load the CSV file 
csv_file = "100.csv"  # e.g. '800.csv' if that's your filename replace it with given csv file 
df = pd.read_csv(csv_file)

# Show column names so you can verify which signal to plot
print("Available columns:", df.columns)

# Replace with the column name of the actual ecg signal (eg, 'MLII', 'V1', etc)
